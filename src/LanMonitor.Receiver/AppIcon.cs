...
/// <summary>
/// 图标加载：exe 旁 SF_view.ico → %AppData%\SF_view\app.ico → 内嵌默认。
/// </summary>
internal static class AppIcon
{
    private const string ExeSideName = "SF_view.ico";
    private const string EmbeddedName = "SF_view.ico";
    ...
    public static Icon Resolve()
    {
        ...
        var config = Path.Combine(ReceiverSettings.ConfigDirectory, "app.ico");
